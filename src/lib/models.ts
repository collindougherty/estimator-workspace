...
export type ProjectEstimateItem = Tables<'project_estimate_items'>
export type ProjectEstimateItemInsert = TablesInsert<'project_estimate_items'>
export type ProjectItemActual = Tables<'project_item_actuals'>
export type ProjectItemActualInsert = TablesInsert<'project_item_actuals'>
